...
<?php echo $this->Form->create('RemovedProfile'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Removed Profile'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RemovedProfile.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('RemovedProfile.id'))); ?></li>
