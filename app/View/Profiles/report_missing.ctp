...
<div class="container-fluid sign_up_page report_missing">
    <h1><?php echo __("REPORT A MISSING PERSON");?></h1>
    <hr>
    <form role="form" id="signup_form" method="post" data-toggle="validator" novalidate="true" class="form-horizontal search_form2" enctype="multipart/form-data" action="">
