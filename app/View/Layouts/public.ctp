...
<html lang="en">
    <head>
        ...
        <?php
            ...
            echo $this->Html->script(array('jquery-1.11.3', 'bootstrap.min', 'fileinput', 'jquery-ui', 'bootstrap-formhelpers.min', 'bootstrap-formhelpers-countries', 'validator.min', 'bootstrapValidator.min','count','jquery.slimscroll.min'));
        ?>
